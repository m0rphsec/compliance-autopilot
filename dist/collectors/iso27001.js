...
class ISO27001Collector {
    ...
    async evaluateA12_2_1() {
        ...
        const securityWorkflows = workflows.workflows.filter((w) => securityKeywords.some((kw) => w.name.toLowerCase().includes(kw)) ||
