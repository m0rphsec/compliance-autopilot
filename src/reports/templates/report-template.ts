 ...
 */
export const SOC2_TEMPLATE: ReportTemplate = {
  framework: 'SOC2',
  title: 'SOC2 Type II Compliance Report',
  description:
    'Service Organization Control 2 (SOC2) compliance assessment based on Trust Services Criteria',
  sections: [
    {
      id: 'executive-summary',
      title: 'Executive Summary',
      content:
        'This report provides an assessment of compliance with SOC2 Trust Services Criteria.',
      order: 1,
    },
    {
      id: 'security',
 ...
 */
export const GDPR_TEMPLATE: ReportTemplate = {
  framework: 'GDPR',
  title: 'GDPR Compliance Report',
  description:
    'General Data Protection Regulation (GDPR) compliance assessment for data protection and privacy',
  sections: [
    {
      id: 'executive-summary',
      title: 'Executive Summary',
      content:
        'This report provides an assessment of GDPR compliance for personal data processing.',
      order: 1,
    },
    {
      id: 'lawfulness',
 ...
 */
export const ISO27001_TEMPLATE: ReportTemplate = {
  framework: 'ISO27001',
  ...
  sections: [
    {
      ...
      title: 'Executive Summary',
      content:
        'This report provides an assessment of ISO 27001 compliance for information security management.',
      order: 1,
    },
    {
      id: 'security-policy',
 ...
 */
export function getTemplate(framework: string): ReportTemplate {
  switch (framework) {
    case 'SOC2':
...
export function getAllTemplates(): ReportTemplate[] {
  return [SOC2_TEMPLATE, GDPR_TEMPLATE, ISO27001_TEMPLATE];
}
